...
export function SidePanel({
  ...
  return (
    <aside
      ...
      className="fixed right-0 top-14 bottom-0 border-l border-border bg-card shadow-lg z-40 overflow-y-auto transition-[width] duration-200 ease-out glass-surface"
