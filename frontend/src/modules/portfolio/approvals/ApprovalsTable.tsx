      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="px-3 py-2 text-xs font-medium text-muted-foreground">CR Summary</TableHead>
            <TableHead className="px-3 py-2 text-xs font-medium text-muted-foreground">Submitted By</TableHead>
            <TableHead className="px-3 py-2 text-xs font-medium text-muted-foreground">Confirmed By</TableHead>
            ...
            <TableHead className="px-3 py-2 text-xs font-medium text-muted-foreground w-[40px]"></TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {sortedItems.map((item) => (
            <TableRow
              ...
              className={cn(
                ...
                selectedId === item.cr_id ? 'bg-primary/5' : 'hover:bg-accent',
              )}
            ...
            >
              ...
              <TableCell className="px-3 py-2 text-sm text-right">
                {item.impact_eur_delta != null ? (
                  <span className={item.impact_eur_delta > 0 ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400'}>
              ...
              <TableCell className="px-3 py-2">
                {item.system_suggested && (
                  <Badge className="bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-400 text-[10px] px-1.5">
