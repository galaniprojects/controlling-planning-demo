  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <h2 className="text-base font-semibold text-slate-800">Rate Tables</h2>
      ...
      <div className="rounded-md border border-slate-200 overflow-auto">
        <Table>
          <TableHeader>
            <TableRow>
              <TableHead className="px-3 py-2 text-xs font-medium text-slate-500">Role</TableHead>
              <TableHead className="px-3 py-2 text-xs font-medium text-slate-500 w-[160px]">Competence Center</TableHead>
              <TableHead className="px-3 py-2 text-xs font-medium text-slate-500 w-[130px]">Current Rate</TableHead>
              <TableHead className="px-3 py-2 text-xs font-medium text-slate-500 w-[150px]">Effective Date</TableHead>
              <TableHead className="px-3 py-2 text-xs font-medium text-slate-500 w-[110px] text-right">Previous Rate</TableHead>
              <TableHead className="px-3 py-2 text-xs font-medium text-slate-500 w-[120px]">Previous Date</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {rates.map((entry) => {
              ...
              return (
                <TableRow
                  key={key}
                  className={isEdited ? 'bg-amber-50 border-l-2 border-l-amber-400' : 'hover:bg-slate-50'}
                >
                  ...
                  <TableCell className="px-3 py-2 text-sm text-slate-400 text-right">
