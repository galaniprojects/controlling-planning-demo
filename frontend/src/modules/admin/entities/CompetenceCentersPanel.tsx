  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <h2 className="text-base font-semibold text-foreground">Competence Centers</h2>
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="px-3 py-2 text-xs font-medium text-muted-foreground w-[130px] text-right">Blended Rate</TableHead>
              ...
              <Fragment key={item.id}>
                ...
                {expandedId === item.id && (
                  <TableRow key={`${item.id}-detail`}>
                    <TableCell colSpan={6} className="px-4 py-3 bg-muted/50 border-t-0">
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          <h3 className="text-sm font-medium text-foreground">Assigned Employees</h3>
                        ...
                        {loadingPeople ? (
                          ...
                          <p className="text-sm text-muted-foreground py-2">No employees assigned</p>
                        ) : (
                          <div className="rounded border border-border bg-card">
                            <Table>
                              <TableHeader>
                                <TableRow>
                                  <TableHead className="px-3 py-1.5 text-xs font-medium text-muted-foreground">Name</TableHead>
                                  <TableHead className="px-3 py-1.5 text-xs font-medium text-muted-foreground w-[160px]">Role</TableHead>
                                  <TableHead className="px-3 py-1.5 text-xs font-medium text-muted-foreground w-[180px]">Cost Center</TableHead>
                                  <TableHead className="px-3 py-1.5 text-xs font-medium text-muted-foreground w-[60px]" />
                                </TableRow>
                              </TableHeader>
                              <TableBody>
                                {ccPeople.map((p) => (
                                  <TableRow key={p.id} className="hover:bg-accent">
                                    ...
                                    <TableCell className="px-3 py-1.5 text-sm text-muted-foreground">{p.role_name}</TableCell>
                                    <TableCell className="px-3 py-1.5 text-sm text-muted-foreground">{p.cost_center_name || '—'}</TableCell>
