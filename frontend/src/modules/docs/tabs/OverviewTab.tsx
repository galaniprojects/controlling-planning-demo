...
const MODULES = [
  ...
  { name: 'What-If Simulator', route: '/simulator', description: 'Scenarios anchored to a forecast version; Tier 1/2/3 levers across 17+ surfaces incl. cost-allocation sandbox; Promote-with-routing; Apply-to-Forecast.' },
