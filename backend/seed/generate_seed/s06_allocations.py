...
def generate() -> str:
    ...
    # --- Resource Requests ---
    parts.append("\n-- Resource Requests")
    parts.append("""INSERT INTO resource_requests (project_id, cost_center_id, request_type, role_type_id, cost_type_id, hours_or_amount_per_month, period_start, period_end, priority, status, assigned_person_id, adjusted_value, explanation, created_at, modified_at) VALUES
