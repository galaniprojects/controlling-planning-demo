...
- `backend/routers/` — `admin.py`, `ai_reports.py`, `audit.py`, `capacity.py`, `charging.py`, `documentation.py`, `global_launchpad.py`, `milestones.py`, `pipeline.py`, `portfolio.py`, `reference.py`, `report_builder.py`, `reports.py`, `scenarios.py`, `scheduled_changes.py`, `tech_navigator.py`, `user_measurement.py`, `workbench.py`, `workflow_templates.py`
- `backend/services/` — `advisor.py`, `ai_report_service.py`, `allocation_service.py`, `audit_export.py`, `audit_query.py`, `calculations.py`, `forecast_cycle.py`, `pipeline.py`, `portfolio_service.py`, `report_builder_catalog.py`, `report_builder_engine.py`, `report_builder_export.py`, `report_builder_saved.py`, `report_service.py`, `scenario_engine.py`, `scheduled_change_activation.py`, `tech_navigator.py`, `user_measurement_import.py`
- `backend/tests/` — unit tests (post-D1+D2 merge: see PROGRESS.md for current count)
