...
- [x] **FD-3 — Stage 1 effective-dated rework** (agent team `fd3-stage1`, 4 teammates, branch `feature/fd3-stage1-effective-dated`, 2026-05-20). Realises spec §4 + tags `[F-S1-01..08]`: first-class `DistributionVersion` header (draft/active, effective-dated, provenance, scenario-scoped fork), per-edge rationale, version diff, per-entity Stage 1 surface, anchor pinning for lever 12. Plan: `~/.claude/plans/sprightly-beaming-quail.md`. **12 atomic commits** across A1/A2/A3/B0/B1/B2/B3/C1×5/D1×2.
