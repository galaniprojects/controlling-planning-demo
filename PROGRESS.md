...
- [ ] **Session 3 — Complete the edit surfaces (breadth)** (in progress, branch `feature/simulator-project-scope-s3` off live `main` @ `5ce3783`, 2026-06-03). Implements spec §3 (full edit catalogue + cost-allocation gap closure), §7 (debounced cross-portfolio feedback), §8 (Tier-3 mix). Lead-does-Phase-0-then-team orchestration.
